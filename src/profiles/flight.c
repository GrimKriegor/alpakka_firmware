...
Profile profile_init_flight() {
    ...
    profile.start_1 =  Button_(PIN_START_1,  NORMAL, ACTIONS(GAMEPAD_AXIS_RZ));
    profile.start_2 =  Button_(PIN_START_2,  NORMAL, ACTIONS(GAMEPAD_R1));
    ...
    profile.r1 = Button_(PIN_R1, NORMAL, ACTIONS(GAMEPAD_START));
    profile.l2 = Button_(PIN_L2, NORMAL, ACTIONS(GAMEPAD_AXIS_LZ));
    profile.r2 = Button_(PIN_R2, NORMAL, ACTIONS(KEY_NONE));
    profile.l4 = Button_(PIN_L4, NORMAL, ACTIONS(GAMEPAD_R3));
